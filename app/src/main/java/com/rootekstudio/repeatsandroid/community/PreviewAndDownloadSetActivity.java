...
public class PreviewAndDownloadSetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (databaseSetID != null) {
            ...
            setItems = SetData.getSetItems();
            setName = SetData.getSetName();
            ...
            String shareDateString = getText(R.string.shareDate) + " " + SetData.getSetCreationDate();
            shareDateTextView.setText(shareDateString);
    ...
    public void downloadSet(View view) {
        ...
        RepeatsDatabase.getInstance(this).insertSetToDatabase(id, questions, answers, null);
